...
search --no-floppy --file --set=root /antix/antix/boot/vmlinuz

linux /antix/antix/boot/vmlinuz bdir=antix/antix toram persist_all disable=f quiet

initrd /antix/antix/boot/initrd.gz
